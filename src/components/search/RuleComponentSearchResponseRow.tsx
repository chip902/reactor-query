...
const RuleComponentSearchResponseRow = ({ item, searchValue, index, highlightSearchInJson }: ResultItemProps) => {
			...
			<button
				...
				<div className="flex flex-col space-y-2 w-full sm:flex-row sm:space-y-0 sm:items-center sm:justify-between">
					<div className="flex items-center space-x-3">
						...
						<span className="px-2 py-1 text-xs bg-blue-100 text-blue-700 rounded-full">{ext}</span>
						<span className="px-2 py-1 text-xs bg-green-100 text-green-700 rounded-full">{rcType}</span>
						<span className="px-2 py-1 text-xs bg-orange-100 text-orange-700 rounded-full">{action}</span>
